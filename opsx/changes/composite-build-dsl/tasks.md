...
- [x] `cbd-2` Add `sanitizedBuildName` to `MonolithRepo` (`core/src/main/kotlin/zone/clanker/gradle/core/MonolithExtension.kt`)
...
- [x] `cbd-3` Unit tests for `sanitizedBuildName` (`core/src/test/kotlin`)
...
- [x] `cbd-4` Apply `sanitizedBuildName` in `MonolithPlugin.includeAction` and fix accessor names (`plugin/src/main/kotlin/zone/clanker/gradle/MonolithPlugin.kt`)
...
- [x] `cbd-5` Integration test: `includeBuild` with space-in-name project (`plugin/src/test/kotlin/zone/clanker/gradle/BuildNameSanitizationTest.kt`)
...
- [x] `cbd-6` Add duplicate name detection to `MonolithExtension` (`core/src/main/kotlin/zone/clanker/gradle/core/MonolithExtension.kt`)
...
- [x] `cbd-7` Test duplicate name detection (`plugin/src/test/kotlin/zone/clanker/gradle/`)
...
- [x] `cbd-8` Add `includeBuild()` method and `includedBuilds` to `MonolithRepo` (`core/src/main/kotlin/zone/clanker/gradle/core/MonolithExtension.kt`)
...
- [x] `cbd-9` Unit tests for `includeBuild()` chaining (`core/src/test/kotlin`)
...
- [x] `cbd-10` Add `includeTree()` to `MonolithExtension` (`core/src/main/kotlin/zone/clanker/gradle/core/MonolithExtension.kt`)
...
- [x] `cbd-11` Wire `includeTree()` in `MonolithPlugin` (`plugin/src/main/kotlin/zone/clanker/gradle/MonolithPlugin.kt`)
...
- [x] `cbd-12` Integration test: tree DSL with transitive substitution (`plugin/src/test/kotlin/zone/clanker/gradle/TreeDslTest.kt`)
...
- [x] `cbd-13` Integration test: tree DSL with duplicate `:app` subprojects (`plugin/src/test/kotlin/zone/clanker/gradle/TreeDslTest.kt`)
...
- [x] `cbd-14` Integration test: `includeEnabled()` still works (backward compat) (`plugin/src/test/kotlin/zone/clanker/gradle/TreeDslTest.kt`)
...
- [x] `cbd-15` Update README with tree DSL docs
