...
abstract class DevloopTask : DefaultTask() {
    ...
    fun generate() {
        ...
        sb.appendLine("|------|--------|")
        sb.appendLine("| `srcx-context` | `.opsx/context.md` — project metadata |")
        sb.appendLine("| `srcx-tree` | `.opsx/tree.md` — source file tree |")
        sb.appendLine("| `srcx-modules` | `.opsx/modules.md` — module graph |")
        sb.appendLine("| `srcx-deps` | `.opsx/deps.md` — dependencies |")
        sb.appendLine("| `srcx-devloop` | `.opsx/devloop.md` — this file |")
        sb.appendLine()
        sb.appendLine("### 🧠 Intelligence (on-demand)")
        sb.appendLine("| Command | What it does |")
        sb.appendLine("|---------|-------------|")
        sb.appendLine("| `/srcx:find <name>` | Find a symbol by name |")
        sb.appendLine("| `/srcx:calls <name>` | Show call graph for a symbol |")
        sb.appendLine("| `srcx-symbols` | Full symbol index (`.opsx/symbols.md`) |")
        sb.appendLine("| `/srcx:rename <old> <new>` | Preview rename refactoring |")
        sb.appendLine()
