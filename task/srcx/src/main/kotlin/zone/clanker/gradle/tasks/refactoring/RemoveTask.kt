...
abstract class RemoveTask : DefaultTask() {
    ...
    init {
        ...
        description = "[tool] Remove a symbol or line range from the codebase, cleaning up imports. " +
            ...
            "Chain: Run srcx-usages first for impact analysis."
    }
    ...
    private fun removeClass(
        sb: StringBuilder,
        sym: zone.clanker.gradle.core.Symbol,
        index: SymbolIndex,
    ...
    private fun removeMember(
        sb: StringBuilder,
        classSym: zone.clanker.gradle.core.Symbol,
        memberName: String,
        index: SymbolIndex,
        sourceFiles: List<File>,
        rootDir: File,
