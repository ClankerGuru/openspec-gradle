...
@CacheableTask
abstract class DevloopTask : DefaultTask() {
    ...
    fun generate() {
        ...
        // ── OPSX Tasks ──
        sb.appendLine("## OPSX Tasks")
        sb.appendLine()
        sb.appendLine("Run `./gradlew opsx` for the full catalog.")
        sb.appendLine()
        sb.appendLine("### 🔍 Discovery (auto-generated on every build)")
        sb.appendLine("| Task | Output |")
        sb.appendLine("|------|--------|")
        sb.appendLine("| `opsx-context` | `.opsx/context.md` — project metadata |")
        sb.appendLine("| `opsx-tree` | `.opsx/tree.md` — source file tree |")
        sb.appendLine("| `opsx-modules` | `.opsx/modules.md` — module graph |")
        sb.appendLine("| `opsx-deps` | `.opsx/deps.md` — dependencies |")
        sb.appendLine("| `opsx-devloop` | `.opsx/devloop.md` — this file |")
        sb.appendLine()
        sb.appendLine("### 🧠 Intelligence (on-demand)")
        sb.appendLine("| Command | What it does |")
        sb.appendLine("|---------|-------------|")
        sb.appendLine("| `/opsx:find <name>` | Find a symbol by name |")
        sb.appendLine("| `/opsx:calls <name>` | Show call graph for a symbol |")
        sb.appendLine("| `opsx-symbols` | Full symbol index (`.opsx/symbols.md`) |")
        sb.appendLine("| `/opsx:rename <old> <new>` | Preview rename refactoring |")
        sb.appendLine()
        sb.appendLine("### 🔧 Workflow")
        sb.appendLine("| Command | What it does |")
        sb.appendLine("|---------|-------------|")
        sb.appendLine("| `/opsx:propose <name>` | Create a change proposal |")
        sb.appendLine("| `/opsx:apply` | Implement tasks from a change |")
        sb.appendLine()
        sb.appendLine("### 📋 Status")
        sb.appendLine("| Command | What it does |")
        sb.appendLine("|---------|-------------|")
        sb.appendLine("| `/opsx:status` | Show status of open changes |")
        sb.appendLine()
